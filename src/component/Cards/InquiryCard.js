...
const InquiryCardRes = ({ data }) => {
    ...
    return (
        <Pressable style={styles.InqWcardWrapper} onPress={() => { navigation.navigate(NavigationStrings.CHAT_SCREEN) }} >
            <View style={styles.upperWrapper} >
                ...
                <View style={styles.TimeContact} >
                    ...
                    <View style={styles.SocialSTyle} >
                        ...
                        <View style={styles.mobileStyle}  >
                            <item.Icon width={'90%'} height={'90%'} style={styles.ForIconShadow} />
                        </View>
                    </View>
                </View>
            </View>
