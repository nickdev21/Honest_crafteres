...
import { Box_Icon, EyeVisible_Icon } from '../../assets/Icons';
    ...
    return (
        <View style={styles.ItemWrapper} >
            <View style={styles.ItemHeadingView} >
                <Box_Icon width={windowWidth / 15} height={windowHeight / 25} />
            ...
            <View style={styles.TextView} >
                <Text style={styles.TextStyle} >Remarks (if any)</Text>
                <Text style={styles.InvoiceCode} >Loreum ispum is dummy text. Loreum ispum is dummy text</Text>
            </View>

            <Text style={styles.TextStyle} >Items Details</Text>
            <View style={styles.DownCardArea} >
                <FlatList listKey={(item, index) => 'D' + index.toString()} data={ItemStaticData} renderItem={RenderCard} showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} />
            </View>
        </View>
    );
};
